...
/*
 * The collection dialog must never become wider than its modal.
 * Only vertical scrolling is useful here.
 */
form,
...
/*
 * Nextcloud modal containers can otherwise retain horizontal
 * overflow generated by a child element.
 */
...
/*
 * Keep actions inside the available dialog width.
 */
form footer,
form [class*="actions"],
form [class*="footer"] {
...
#bw-collection-organization:not(:disabled) {
  border-color: var(--color-border-dark);
}

#bw-collection-organization:focus-visible {
  outline: 2px solid var(--color-primary-element);
  outline-offset: 1px;
}

#bw-collection-organization:disabled {
  cursor: default;
}
</style>
